(function () {
  ...
  // 「高い」「美しい」のような形容詞は名詞前で使われることが多いので終端扱いにしない。
  // 終助詞や明確な完結語句、過去形(~た)、動詞意志形(~よう/~こう/etc)、コピュラを終端扱い。
  const TERM_RE = /(?:[。！？♪～\.\!\?]|です|でした|だ|だね|だな|だよ|だから|だろう|でしょう|ます|ません|ましょう|ない|たい|よう|こう|もう|そう|った|れた|いる|いた|いました|おりました|おる|ある|あった|ありました|楽しい|嬉しい|怖い|気持ちいい|気持ちがいい|最高|大好き|好き|心配だ|困る|残念|変|信じられない|見える|聞こえる|もいる|がいる|思う|ね|よ|わ|さ|な|かな|よね|もん|から|けど|ので)$/;
